...
public class dashboardController implements Initializable{
    ...
    public void dashboardTI(){
        ...
        try{
            ...
            result = prepare.executeQuery();
            if(result.next()){
                sumTotal = result.getInt("SUM(total)");
            }
    ...
    public void availableBooksAdd(){
        ...
        try{
            ...
            if(availableBooks_bookID.getText().isEmpty()
                ...
                //PERIKSA APAKAH ID BUKU SUDAH ADA
                ...
                if(result.next()){
                    ...
                    alert.setTitle("Pesan Kesalahan");
                    alert.setHeaderText(null);
                    alert.setContentText("Book ID: " + availableBooks_bookID.getText() + " sudah ada!");
                    alert.showAndWait();
                }else{
                    ...
                    //UNTUK MEMPERBARUI TAMPILAN TABEL (TABLEVIEW) 
    ...
    public void availableBooksUpdate(){
        ...
        try{
            ...
            if(availableBooks_bookID.getText().isEmpty()
                ...
                alert.setHeaderText(null);
                alert.setContentText("Apakah Anda yakin nihh ingin MEMPERBAHARUI ID Buku : " + availableBooks_bookID.getText() + "?");
                ...
                if(option.get().equals(ButtonType.OK)){
                    ...
                    alert.setTitle("Pesan Informasi");
                    alert.setHeaderText(null);
                    alert.setContentText("Berhasil Diperbaharui!");
                    alert.showAndWait();
    ...
    public void availableBooksDelete(){
        ...
        try{
            ...
            if(availableBooks_bookID.getText().isEmpty()
                ...
                alert.setTitle("Pesan Konfirmasi");
                alert.setHeaderText(null);
                alert.setContentText("Apakah Anda yakin nihh ingin MENGHAPUS ID Buku : " + availableBooks_bookID.getText() + "?");
                Optional<ButtonType> option = alert.showAndWait();
                ...
                if(option.get().equals(ButtonType.OK)){
                    ...
                    alert.setTitle("Pesan Informasi");
                    alert.setHeaderText(null);
                    alert.setContentText("Berhasil Menghapus!");
                    alert.showAndWait();
        ...
        try{
            ...
            while(result.next()){
                bookD = new bookData(result.getInt("book_id"), result.getString("title")
                        ...
                        , result.getDate("pub_date"), result.getInt("price")
    ...
    public void purchaseAdd(){
        ...
        try{
            ...
            if(purchase_bookTitle.getSelectionModel().getSelectedItem() == null
                ...
                alert.setTitle("Pesan Kesalahan");
                alert.setHeaderText(null);
                alert.setContentText("Silakan pilih buku terlebih dahulu");
                alert.showAndWait();
            }else{
    ...
    public void purchasePay(){
        ...
        try{
            ...
            if(displayTotal == 0){
                ...
                alert.setTitle("Pesan Kesalahan");
                alert.setHeaderText(null);
                alert.setContentText("Coba periksa lagi :)");
                alert.showAndWait();
            }else{
                alert = new Alert(AlertType.CONFIRMATION);
                alert.setTitle("Pesan Konfirmasi");
                alert.setHeaderText(null);
                alert.setContentText("Yakin nihh mau bayar ?");
                Optional<ButtonType> option = alert.showAndWait();
    ...
    public void purchaseDisplayTotal(){
        ...
        try{
            ...
            if(result.next()){
                displayTotal = result.getInt("SUM(price)");
            }
            
            purchase_total.setText("Rp " + String.valueOf(displayTotal));
    ...
    public void logout(){
        try{
            ...
            alert.setTitle("Pesan Konfirmasi");
            alert.setHeaderText(null);
            alert.setContentText("Apakah yakin nihh ingin keluar ?");
            Optional<ButtonType> option = alert.showAndWait();
            
            if(option.get().equals(ButtonType.OK)){
                //MENYEMBUNYIKAN DASHBOARD
                logout.getScene().getWindow().hide();
                //TAUTKAN FORMULIR LOGIN ANDA
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //UNTUK MENAMPILKAN DATA PADA TAMPILAN TABEL (BUKU YANG TERSEDIA (AVAILABLE BOOKS))
        availableBooksShowListData();
        purchaseBookId();
        purchaseBookTitle();
        purchaseShowCustomerListData();
